...
const Wrapper = memo(() => {
    return (_jsx(ErrorBoundaryWrapper, { children: _jsxs(SafeAreaProvider, { initialMetrics: {
            ...
            }, children: [_jsx(App, {}), _jsx(GlobalErrorReporter, {}), _jsx(Toaster, {})] }) }));
});
...
const CreateApp = () => {
    ...
    return (_jsx(_Fragment, { children: _jsx(Wrapper, {}) }));
};
